...
int main() {
    auto [gamma, epsilon, lines] = std::tuple{std::string(), std::string(), std::vector<std::string>{}};
    ...
    std::cout << std::stoi(gamma, nullptr, 2) * std::stoi(epsilon, nullptr, 2) << std::endl << std::stoi(check_scrub_power(lines, false).at(0), nullptr, 2) * std::stoi(check_scrub_power(lines, true).at(0), nullptr, 2) << std::endl; }